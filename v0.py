    ...
    if request.method == 'POST':
        ...
        try:
            ...
            dL1raw = raw_data.objects.filter(conditions1 & query & query1, l1_status='completed').annotate(timtakn=Sum(F('l1_prod_id__end_time') - F('l1_prod_id__start_time'))).values('id', 'l1_prod_id__end_time__date', 'id_value', 'l1_prod_id', 'l1_emp_id__employeeID', 'question', 'asin', 'product_url', 'title', 'evidence', 'imagepath', 'answer_one', 'answer_two', 'l1_prod_id__general_ques1', 'l1_prod_id__general_ques2', 'l1_prod_id__start_time', 'l1_prod_id__end_time',
                                                                                                                                                                                        ...
                                                                                                                                                                                        'l1_prod__que14_ans2',
                                                                                                                                                                                        'l1_prod__que15_ans2',
                                                                                                                                                                                        'l1_prod__annotation_comment').exclude(status__in=['hold', 'deleted'])
            ...
            dL2raw = raw_data.objects.filter(conditions2 & query & query1, l2_status='completed').annotate(timtakn=Sum(F('l2_prod_id__end_time') - F('l2_prod_id__start_time'))).values('id', 'l2_prod_id__end_time__date', 'id_value', 'l2_prod_id', 'l2_emp_id__employeeID', 'question', 'asin', 'product_url', 'title', 'evidence', 'imagepath', 'answer_one', 'answer_two', 'l2_prod_id__general_ques1', 'l2_prod_id__general_ques2', 'l2_prod_id__start_time', 'l2_prod_id__end_time',
                                                                                                                                                                                        ...
                                                                                                                                                                                        'l2_prod__que14_ans2',
                                                                                                                                                                                        'l2_prod__que15_ans2',
                                                                                                                                                                                        'l2_prod__annotation_comment').exclude(status__in=['hold', 'deleted'])
            ...
            dL3raw = raw_data.objects.filter(conditions3 & query & query1, l3_status='completed').annotate(timtakn=Sum(F('l3_prod_id__end_time') - F('l3_prod_id__start_time'))).values('id', 'l3_prod_id__end_time__date', 'id_value', 'l3_prod_id', 'l3_emp_id__employeeID', 'question', 'asin', 'product_url', 'title', 'evidence', 'imagepath', 'answer_one', 'answer_two', 'l3_prod_id__general_ques1', 'l3_prod_id__general_ques2', 'l3_prod_id__start_time', 'l3_prod_id__end_time',
                                                                                                                                                                                        'l3_emp_id__employeeName', 'l3_emp_id__location', 'baseid_id__batch_name', 'baseid_id__filename', 'l3_status', 'timtakn','l3_prod__que1',
                                                                                                                                                                                        'l3_prod__que2',
                                                                                                                                                                                        'l3_prod__que3_ans1',
                                                                                                                                                                                        'l3_prod__que5_ans1',
                                                                                                                                                                                        'l3_prod__que6_ans1',
                                                                                                                                                                                        ...
                                                                                                                                                                                        'l3_prod__que14_ans2',
                                                                                                                                                                                        'l3_prod__que15_ans2',
                                                                                                                                                                                        'l3_prod__annotation_comment' ).exclude(status__in=['hold', 'deleted'])
            ...
            dL4raw = raw_data.objects.filter(conditions4 & query & query1, l1_l2_accuracy='pass').annotate(timtakn=Sum(F('l4_prod_id__end_time') - F('l4_prod_id__start_time'))).values('id', 'l4_prod_id__end_time__date', 'id_value', 'l4_prod_id', 'l4_emp_id__employeeID', 'question', 'asin', 'product_url', 'title', 'evidence', 'imagepath', 'answer_one', 'answer_two', 'l4_prod_id__general_ques1', 'l4_prod_id__general_ques2', 'l4_prod_id__start_time', 'l4_prod_id__end_time',
                                                                                                                                                                                        'l4_emp_id__employeeName', 'l4_emp_id__location', 'baseid_id__batch_name', 'baseid_id__filename', 'l4_status', 'timtakn', 'l4_prod__que1',
                                                                                                                                                                                        'l4_prod__que2',
                                                                                                                                                                                        'l4_prod__que3_ans1',
                                                                                                                                                                                        'l4_prod__que5_ans1',
                                                                                                                                                                                        'l4_prod__que6_ans1',
                ...
                if reporttype == 'DA1':
                    for v in dL1raw:
                        records = [
                            ...
                            v['l1_prod_id__que12_ans1'],
                            v['l1_prod_id__que13_ans1'],
                            v['l1_prod_id__que14_ans1'],
                            v['l1_prod_id__que15_ans1'],
                            ...
                            v['l1_prod_id__que12_ans2'],
                            v['l1_prod_id__que13_ans2'],
                            v['l1_prod_id__que14_ans2'],
                            v['l1_prod_id__que15_ans2'],
                ...
                if reporttype == 'DA2':
                    for v in dL2raw:
                        records = [
                            ...
                            v['l2_prod_id__que12_ans1'],
                            v['l2_prod_id__que13_ans1'],
                            v['l2_prod_id__que14_ans1'],
                            v['l2_prod_id__que15_ans1'],
                            ...
                            v['l2_prod_id__que12_ans2'],
                            v['l2_prod_id__que13_ans2'],
                            v['l2_prod_id__que14_ans2'],
                            v['l2_prod_id__que15_ans2'],
                ...
                if reporttype == 'QC/QA':
                    for v in dL3raw:
                        records = [
                            ...
                            v['l3_prod_id__que12_ans1'],
                            v['l3_prod_id__que13_ans1'],
                            v['l3_prod_id__que14_ans1'],
                            v['l3_prod_id__que15_ans1'],
                            ...
                            v['l3_prod_id__que12_ans2'],
                            v['l3_prod_id__que13_ans2'],
                            v['l3_prod_id__que14_ans2'],
                            v['l3_prod_id__que15_ans2'],
                        ...
                        for v in dL4raw:
                            ...
                            if mv['id_value'] == v['id_value'] and v['l4_emp_id__employeeID'] != None and v['l4_prod_id__start_time'] != None and v['l4_prod_id__end_time'] != None:
                                ...
                                records.extend([
                                    ...
                                    mv['l4_prod_id__que1'],
                                    mv['l4_prod_id__que2'],
                                    mv['l4_prod_id__que3_ans1'],
                                    mv['l4_prod_id__que5_ans1'],
                                    mv['l4_prod_id__que6_ans1'],
                                    mv['l4_prod_id__que7_ans1'],
                                    mv['l4_prod_id__que8_ans1'],
                                    mv['l4_prod_id__que9_ans1'],
                                    mv['l4_prod_id__que10_ans1'],
                                    mv['l4_prod_id__que11_ans1'],
                                    mv['l4_prod_id__que12_ans1'],
                                    mv['l4_prod_id__que13_ans1'],
                                    mv['l4_prod_id__que14_ans1'],
                                    mv['l4_prod_id__que15_ans1'],
                                    mv['l4_prod_id__que3_ans2'],
                                    mv['l4_prod_id__que5_ans2'],
                                    mv['l4_prod_id__que6_ans2'],
                                    mv['l4_prod_id__que7_ans2'],
                                    mv['l4_prod_id__que8_ans2'],
                                    mv['l4_prod_id__que9_ans2'],
                                    mv['l4_prod_id__que10_ans2'],
                                    mv['l4_prod_id__que11_ans2'],
                                    mv['l4_prod_id__que12_ans2'],
                                    mv['l4_prod_id__que13_ans2'],
                                    mv['l4_prod_id__que14_ans2'],
                                    mv['l4_prod_id__que15_ans2'],
                                    mv['l4_prod_id__annotation_comment'],
