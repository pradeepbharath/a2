...
def project_management(request):
    ...
    if request.method == 'POST':
        ...
        if key == 'language':
            ...
            Languages.objects.update_or_create(language=language,defaults={'created_by_id' : EmpID})
            return render(request, 'pages/projectmanagement.html',{'status':200,'message':'success'})
        if key == 'location':
            location = request.POST.get('location')
            Location.objects.update_or_create(location=location,defaults={'created_by_id' : EmpID})
            return render(request, 'pages/projectmanagement.html',{'status':200,'message':'success'})
    else:
...
def loneproductionView(request):
    ...
    if request.method == 'GET':
        try:
            with transaction.atomic():
                l1_count = raw_data.objects.filter(Q(l1_prod_id__end_time__date=timezone.now().date()),Q(l1_status='completed') & Q(l1_emp_id=EmpID)).exclude(status__in=['hold', 'deleted']).count()
        ...
        que3_ans1 = request.POST.getlist('que3_ans1',None)
        que4_ans1 = request.POST.getlist('que4_ans1[]',None) # links
        ...
        que9_ans1 = request.POST.get('que9_ans1',None)
        que10_ans1 = request.POST.get('que10_ans1',None)
        que11_ans1 = request.POST.get('que11_ans1',None)
        que12_ans1 = request.POST.get('que12_ans1',None)
        que13_ans1 = request.POST.get('que13_ans1',None)
        que14_ans1 = request.POST.get('que14_ans1',None)
        que15_ans1 = request.POST.get('que15_ans1',None)

        que3_ans2 = request.POST.getlist('que3_ans2',None)
        que4_ans2 = request.POST.getlist('que4_ans2[]',None) # links
        ...
        que9_ans2 = request.POST.get('que9_ans2',None)
        que10_ans2 = request.POST.get('que10_ans2',None)
        que11_ans2 = request.POST.get('que11_ans2',None)
        que12_ans2 = request.POST.get('que12_ans2',None)
        que13_ans2 = request.POST.get('que13_ans2',None)
        que14_ans2 = request.POST.get('que14_ans2',None)
        que15_ans2 = request.POST.get('que15_ans2',None)
        annotation_comment = request.POST.get('annotation_comment',None)
            ...
            try:
                with transaction.atomic():
                    ...
                    l1prod.update(end_time=timezone.now(),
                                    que1 = que1,
                                    que2 = que2,
                                    que3_ans1 = ','.join(que3_ans1),
                                    que5_ans1 = que5_ans1,
                                    que6_ans1 = que6_ans1,
                                    que7_ans1 = que7_ans1,
                                    que8_ans1 = que8_ans1,
                                    que9_ans1 = que9_ans1,
                                    que10_ans1 = que10_ans1,
                                    que11_ans1 = que11_ans1,
                                    que12_ans1 = que12_ans1,
                                    que13_ans1 = que13_ans1,
                                    que14_ans1 = que14_ans1,
                                    que15_ans1 = que15_ans1,

                                    que3_ans2 = ','.join(que3_ans2),
                                    que5_ans2 = que5_ans2,
                                    que6_ans2 = que6_ans2,
                                    que7_ans2 = que7_ans2,
                                    que8_ans2 = que8_ans2,
                                    que9_ans2 = que9_ans2,
                                    que10_ans2 = que10_ans2,
                                    que11_ans2 = que11_ans2,
                                    que12_ans2 = que12_ans2,
                                    que13_ans2 = que13_ans2,
                                    que14_ans2 = que14_ans2,
                                    que15_ans2 = que15_ans2,
                                    annotation_comment = annotation_comment, is_production_status='Completed', created_by_id=EmpID)

                    l1prod_values = l1prod.values_list('id', flat=True)

                    link_objects = [
                        l1_production_link(
                            production_id=l1prod_values, link=value, linkfor='q4_1')
                        for value in que4_ans1 if value
                    ] + [
                        l1_production_link(
                            production_id=l1prod_values, link=value, linkfor='q4_2')
                        for value in que4_ans2 if value
                    ]
...
def ltwoproductionView(request):
    ...
    if request.method == 'GET':
        try:
            with transaction.atomic():
                l2_count = raw_data.objects.filter(Q(l2_prod_id__end_time__date=timezone.now().date()), Q(l2_status='completed') & Q(l2_emp_id=EmpID)).exclude(status__in=['hold', 'deleted']).count()
        ...
        if key == 'submit':
            try:
                ...
                link_objects = [
                    l2_production_link(
                        production_id=l2prod_values, link=value, linkfor='q4_1')
                    for value in que4_ans1 if value
                ] + [
                    l2_production_link(
                        production_id=l2prod_values, link=value, linkfor='q4_2')
                    for value in que4_ans2 if value
                ]
...
def l1_l2Comparison(id):
    l1_prod = l1_production.objects.filter(qid_id=id).values('id', 'que1', 'que2', 'que3_ans1', 'que5_ans1', 'que6_ans1', 'que7_ans1', 'que8_ans1', 'que9_ans1', 'que10_ans1',
                                                                'que11_ans1','que12_ans1','que13_ans1','que14_ans1','que15_ans1','que3_ans2','que5_ans2','que6_ans2',
                                                                'que7_ans2','que8_ans2','que9_ans2','que10_ans2','que11_ans2','que12_ans2','que13_ans2','que14_ans2','que15_ans2')
    l2_prod = l2_production.objects.filter(qid_id=id).values('id', 'que1', 'que2', 'que3_ans1', 'que5_ans1', 'que6_ans1', 'que7_ans1', 'que8_ans1', 'que9_ans1', 'que10_ans1',
                                                                'que11_ans1','que12_ans1','que13_ans1','que14_ans1','que15_ans1','que3_ans2','que5_ans2','que6_ans2',
                                                                'que7_ans2','que8_ans2','que9_ans2','que10_ans2','que11_ans2','que12_ans2','que13_ans2','que14_ans2','que15_ans2')
    ...
    if not df1.empty and not df2.empty:
        ...
        fields_to_compare = ['que1', 'que2', 'que3_ans1', 'que5_ans1', 'que6_ans1', 'que7_ans1', 'que8_ans1', 'que9_ans1', 'que10_ans1',
                                                                'que11_ans1','que12_ans1','que13_ans1','que14_ans1','que15_ans1','que3_ans2','que5_ans2','que6_ans2',
                                                                'que7_ans2','que8_ans2','que9_ans2','que10_ans2','que11_ans2','que12_ans2','que13_ans2','que14_ans2','que15_ans2']
        ...
        l2_generalcommndas = l2_production.objects.filter(qid_id=id).values('annotation_comment')[0]
...
def lthreeproductionView(request):
    ...
    if request.method == "POST":
                ...
                with transaction.atomic():
                    ...
                    link_objects = [
                        QcQa_production_link(
                            l3production_id=l3prod_values, link=value, linkfor='q4_1', prodtype='QC')
                        for value in que4_ans1 if value
                    ] + [
                        QcQa_production_link(
                            l3production_id=l3prod_values, link=value, linkfor='q4_2', prodtype='QC')
                        for value in que4_ans2 if value
                    ]
                    with transaction.atomic():
        ...
        l3_count = raw_data.objects.filter(Q(l3_prod_id__end_time__date=timezone.now().date()), Q(l3_status='completed') & Q(l3_emp_id=EmpID)).exclude(status__in=['hold', 'deleted']).count()
        ...
        try:
            ...
            with transaction.atomic():
                rawData = raw_data.objects.select_for_update(skip_locked=True).filter(Q(l1_status='completed') & Q(l2_status='completed') & query, (Q(l3_status='not_moved') & Q(l3_emp_id__isnull=True)) | (Q(l3_status='picked') & Q(l3_emp_id=EmpID)),
                    (Q(l1_l2_accuracy__isnull=True) | Q(l1_l2_accuracy='fail'))).values('id', 'id_value', 'question', 'asin', 'title', 'product_url', 'imagepath', 'evidence', 'answer_one', 'answer_two').exclude(status__in=['hold', 'deleted']).exclude(l1_l2_accuracy='pass').exclude(l1_emp_id=EmpID).exclude(l2_emp_id=EmpID).order_by('-l3_status').first()
                if rawData:                
                    ...
                    if l3comp:
                        ...
                        if 'Not Matched' in l3input['Comparison'].values:
                            ...
                            if l3_production.objects.filter(qid_id=rawData['id']).exists():
                                ...
                                prodid = l3_production.objects.create(qid_id=rawData['id'],start_time = timezone.now(), created_by_id=EmpID)
                                raw_data.objects.filter(id=rawData['id']).update(
    ...
    if request.method == "POST":
        ...
        if key == 'submit':
            try:
                ...
                link_objects = [
                    QcQa_production_link(
                        l4production_id=l4prod_values, link=value, linkfor='q4_1', prodtype='QA')
                    for value in que4_ans1 if value
                ] + [
                    QcQa_production_link(
                        l4production_id=l4prod_values, link=value, linkfor='q4_2', prodtype='QA')
                    for value in que4_ans2 if value
                ]
                with transaction.atomic():
                    QcQa_production_link.objects.bulk_create(link_objects)
        ...
        filenames = raw_data.objects.values('baseid_id','baseid_id__filename').exclude(status__in=['hold', 'deleted']).distinct()
        l4_count = raw_data.objects.filter(Q(l4_prod_id__end_time__date=timezone.now().date()), Q(l4_status='completed') & Q(l4_emp_id=EmpID)).exclude(status__in=['hold', 'deleted']).count()
        ...
        if batcQueue:
            try:
                ...
                filecount = raw_data.objects.filter(l1_l2_accuracy='pass',baseid_id = BaseID).exclude(status__in=['hold', 'deleted']).aggregate(comp_count= Count('l4_status',Q(l4_status='completed')), cur_count= Count('l4_status',Q(l4_status='not_picked')),total_count=Count('l1_l2_accuracy',Q(l1_l2_accuracy = 'pass')))
                getdata_for_target = QA_queue.objects.filter(queue_batch_id=BaseID).aggregate(queue = Sum(Cast('queue_percentage', models.IntegerField())))
                target_percentage = int(getdata_for_target['queue'])

                queue = int(target_percentage / 100 * int(filecount['total_count']))
                
                
                
                print("Total :",int(filecount['total_count']), "Queue :",queue, "Competed :",filecount['comp_count'], "Target % :",getdata_for_target)
...
def outputDownload(request):
    ...
    filenames = raw_data.objects.values('baseid_id__filename').exclude(
        status__in=['hold', 'deleted']).distinct()
    langs =  Languages.objects.values('language')
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            dL1raw = raw_data.objects.filter(conditions1 & query & query1, l1_status='completed').annotate(timtakn=Sum(F('l1_prod_id__end_time') - F('l1_prod_id__start_time'))).values('id', 'l1_prod_id__end_time__date', 'id_value', 'l1_prod_id', 'l1_emp_id__employeeID', 'question', 'asin', 'product_url', 'title', 'evidence', 'imagepath', 'answer_one', 'answer_two', 'l1_prod_id__general_ques1', 'l1_prod_id__general_ques2', 'l1_prod_id__start_time', 'l1_prod_id__end_time',
                                                                                                                                                                                        'l1_emp_id__employeeName', 'l1_emp_id__location', 'baseid_id__batch_name', 'baseid_id__filename', 'l1_status', 'timtakn', 'l1_prod_id__que1', 'l1_prod_id__que2', 'l1_prod_id__que2_1', 'l1_prod_id__annotation_comment', 'l1_prod_id__is_status', 'l1_prod_id__is_present_both', 'l1_prod_id__que4_ans1', 'l1_prod_id__que4_ans11', 'l1_prod_id__que5_ans1',
                                                                                                                                                                                        'l1_prod_id__que6_ans1', 'l1_prod_id__que7_ans1', 'l1_prod_id__que8_ans1', 'l1_prod_id__que9_ans1', 'l1_prod_id__que10_ans1', 'l1_prod_id__que11_ans1', 'l1_prod_id__que11_ans11', 'l1_prod_id__que4_ans2', 'l1_prod_id__que4_ans22', 'l1_prod_id__que5_ans2', 'l1_prod_id__que6_ans2', 'l1_prod_id__que7_ans2',
                                                                                                                                                                                        'l1_prod_id__que8_ans2', 'l1_prod_id__que9_ans2', 'l1_prod_id__que10_ans2', 'l1_prod_id__que11_ans2', 'l1_prod_id__que11_ans22').exclude(status__in=['hold', 'deleted'])
            ...
            dL2raw = raw_data.objects.filter(conditions2 & query & query1, l2_status='completed').annotate(timtakn=Sum(F('l2_prod_id__end_time') - F('l2_prod_id__start_time'))).values('id', 'l2_prod_id__end_time__date', 'id_value', 'l2_prod_id', 'l2_emp_id__employeeID', 'question', 'asin', 'product_url', 'title', 'evidence', 'imagepath', 'answer_one', 'answer_two', 'l2_prod_id__general_ques1', 'l2_prod_id__general_ques2', 'l2_prod_id__start_time', 'l2_prod_id__end_time',
                                                                                                                                                                                        'l2_emp_id__employeeName', 'l2_emp_id__location', 'baseid_id__batch_name', 'baseid_id__filename', 'l2_status', 'timtakn', 'l2_prod_id__que1', 'l2_prod_id__que2', 'l2_prod_id__que2_1', 'l2_prod_id__annotation_comment', 'l2_prod_id__is_status', 'l2_prod_id__is_present_both', 'l2_prod_id__que4_ans1', 'l2_prod_id__que4_ans11', 'l2_prod_id__que5_ans1',
                                                                                                                                                                                        'l2_prod_id__que6_ans1', 'l2_prod_id__que7_ans1', 'l2_prod_id__que8_ans1', 'l2_prod_id__que9_ans1', 'l2_prod_id__que10_ans1', 'l2_prod_id__que11_ans1', 'l2_prod_id__que11_ans11', 'l2_prod_id__que4_ans2', 'l2_prod_id__que4_ans22', 'l2_prod_id__que5_ans2', 'l2_prod_id__que6_ans2', 'l2_prod_id__que7_ans2',
                                                                                                                                                                                        'l2_prod_id__que8_ans2', 'l2_prod_id__que9_ans2', 'l2_prod_id__que10_ans2', 'l2_prod_id__que11_ans2', 'l2_prod_id__que11_ans22').exclude(status__in=['hold', 'deleted'])
            ...
            dL3raw = raw_data.objects.filter(conditions3 & query & query1, l3_status='completed').annotate(timtakn=Sum(F('l3_prod_id__end_time') - F('l3_prod_id__start_time'))).values('id', 'l3_prod_id__end_time__date', 'id_value', 'l3_prod_id', 'l3_emp_id__employeeID', 'question', 'asin', 'product_url', 'title', 'evidence', 'imagepath', 'answer_one', 'answer_two', 'l3_prod_id__general_ques1', 'l3_prod_id__general_ques2', 'l3_prod_id__start_time', 'l3_prod_id__end_time',
                                                                                                                                                                                        'l3_emp_id__employeeName', 'l3_emp_id__location', 'baseid_id__batch_name', 'baseid_id__filename', 'l3_status', 'timtakn', 'l3_prod_id__que1', 'l3_prod_id__que2', 'l3_prod_id__que2_1', 'l3_prod_id__annotation_comment', 'l3_prod_id__is_status', 'l3_prod_id__is_present_both', 'l3_prod_id__que4_ans1', 'l3_prod_id__que4_ans11', 'l3_prod_id__que5_ans1',
                                                                                                                                                                                        'l3_prod_id__que6_ans1', 'l3_prod_id__que7_ans1', 'l3_prod_id__que8_ans1', 'l3_prod_id__que9_ans1', 'l3_prod_id__que10_ans1', 'l3_prod_id__que11_ans1', 'l3_prod_id__que11_ans11', 'l3_prod_id__que4_ans2', 'l3_prod_id__que4_ans22', 'l3_prod_id__que5_ans2', 'l3_prod_id__que6_ans2', 'l3_prod_id__que7_ans2',
                                                                                                                                                                                        'l3_prod_id__que8_ans2', 'l3_prod_id__que9_ans2', 'l3_prod_id__que10_ans2', 'l3_prod_id__que11_ans2', 'l3_prod_id__que11_ans22').exclude(status__in=['hold', 'deleted'])
            ...
            dL4raw = raw_data.objects.filter(conditions4 & query & query1, l1_l2_accuracy='pass').annotate(timtakn=Sum(F('l4_prod_id__end_time') - F('l4_prod_id__start_time'))).values('id', 'l4_prod_id__end_time__date', 'id_value', 'l4_prod_id', 'l4_emp_id__employeeID', 'question', 'asin', 'product_url', 'title', 'evidence', 'imagepath', 'answer_one', 'answer_two', 'l4_prod_id__general_ques1', 'l4_prod_id__general_ques2', 'l4_prod_id__start_time', 'l4_prod_id__end_time',
                                                                                                                                                                                        'l4_emp_id__employeeName', 'l4_emp_id__location', 'baseid_id__batch_name', 'baseid_id__filename', 'l4_status', 'timtakn', 'l4_prod_id__que1', 'l4_prod_id__que2', 'l4_prod_id__que2_1', 'l4_prod_id__annotation_comment', 'l4_prod_id__is_status', 'l4_prod_id__is_present_both', 'l4_prod_id__que4_ans1', 'l4_prod_id__que4_ans11', 'l4_prod_id__que5_ans1',
                                                                                                                                                                                        'l4_prod_id__que6_ans1', 'l4_prod_id__que7_ans1', 'l4_prod_id__que8_ans1', 'l4_prod_id__que9_ans1', 'l4_prod_id__que10_ans1', 'l4_prod_id__que11_ans1', 'l4_prod_id__que11_ans11', 'l4_prod_id__que4_ans2', 'l4_prod_id__que4_ans22', 'l4_prod_id__que5_ans2', 'l4_prod_id__que6_ans2', 'l4_prod_id__que7_ans2',
                                                                                                                                                                                        'l4_prod_id__que8_ans2', 'l4_prod_id__que9_ans2', 'l4_prod_id__que10_ans2', 'l4_prod_id__que11_ans2', 'l4_prod_id__que11_ans22').exclude(status__in=['hold', 'deleted'])
                ...
                if reporttype == 'DA1':
                    for v in dL1raw:
                        records = [
                            ...
                            v['l1_prod_id__que11_ans11'],

                            v['l1_prod_id__que4_ans2'],
                            v['l1_prod_id__que4_ans22'],
                            ...
                            v['l1_prod_id__que11_ans22'],

                            v['l1_prod_id__general_ques1'],
                ...
                if reporttype == 'DA2':
                    for v in dL2raw:
                        records = [
                            ...
                            v['l2_prod_id__que11_ans11'],

                            v['l2_prod_id__que4_ans2'],
                            v['l2_prod_id__que4_ans22'],
                            ...
                            v['l2_prod_id__que11_ans22'],

                            v['l2_prod_id__general_ques1'],
                ...
                if reporttype == 'QC/QA':
                    for v in dL3raw:
                        records = [
                            ...
                            v['l3_prod_id__que11_ans11'],

                            v['l3_prod_id__que4_ans2'],
                            v['l3_prod_id__que4_ans22'],
                            ...
                            v['l3_prod_id__que11_ans22'],

                            v['l3_prod_id__general_ques1'],
                        ...
                        for v in dL4raw:
                            ...
                            if mv['id_value'] == v['id_value'] and v['l4_emp_id__employeeID'] != None and v['l4_prod_id__start_time'] != None and v['l4_prod_id__end_time'] != None:
                                records.extend([
                                    ...
                                    v['l4_prod_id__que11_ans11'],

                                    v['l4_prod_id__que4_ans2'],
                                    v['l4_prod_id__que4_ans22'],
                                    ...
                                    v['l4_prod_id__que11_ans22'],

                                    v['l4_prod_id__general_ques1'],
                                ...
                                records.extend([
                                    ...
                                    mv['l1_prod_id__que1'],
                                    mv['l1_prod_id__que2'],
                                    mv['l1_prod_id__que2_1'],
                                    mv['l1_prod_id__is_present_both'],

                                    mv['l1_prod_id__que4_ans1'],
                                    mv['l1_prod_id__que4_ans11'],
                                    mv['l1_prod_id__que5_ans1'],
                                    mv['l1_prod_id__que6_ans1'],
                                    mv['l1_prod_id__que7_ans1'],
                                    " | ".join([i['link'] for i in dL1link if i['linkfor']
                                                == 'q7_1' and i['production_id'] == mv['l1_prod_id']]),
                                    mv['l1_prod_id__que8_ans1'],
                                    mv['l1_prod_id__que9_ans1'],
                                    mv['l1_prod_id__que10_ans1'],
                                    mv['l1_prod_id__que11_ans1'],
                                    mv['l1_prod_id__que11_ans11'],

                                    mv['l1_prod_id__que4_ans2'],
                                    mv['l1_prod_id__que4_ans22'],
                                    mv['l1_prod_id__que5_ans2'],
                                    mv['l1_prod_id__que6_ans2'],
                                    mv['l1_prod_id__que7_ans2'],
                                    " | ".join([i['link'] for i in dL1link if i['linkfor']
                                                == 'q7_2' and i['production_id'] == mv['l1_prod_id']]),
                                    mv['l1_prod_id__que8_ans2'],
                                    mv['l1_prod_id__que9_ans2'],
                                    mv['l1_prod_id__que10_ans2'],
                                    mv['l1_prod_id__que11_ans2'],
                                    mv['l1_prod_id__que11_ans22'],

                                    mv['l1_prod_id__general_ques1'],
                                    mv['l1_prod_id__general_ques2'],

                                    mv['l1_prod_id__annotation_comment'],
...
def resetuser(request):
    filenames = raw_data.objects.filter().values(
        'baseid_id', 'baseid__filename').exclude(status__in=['hold', 'deleted']).distinct()
    if request.method == 'POST':
...
def ck_report(request):
    filenames = raw_data.objects.values('baseid_id', 'baseid_id__filename').exclude(
        status__in=['hole', 'deleted']).distinct()
    langs =  Languages.objects.values('language')
    locations =  Location.objects.values('location')
    if request.method == "POST":
        key = request.POST.get('key')
        ...
        if not df_datas.empty:
            ...
            df_datas = df_datas[df_datas['l1_prod_id__general_ques1'].isin(df_datas['l2_prod_id__general_ques1'])]
            df_datas = df_datas[df_datas['l2_prod_id__general_ques1'].isin(df_datas['l1_prod_id__general_ques1'])]
            ...
            try:
                answer1 = pivot_table.loc['A is better than B', 'A is better than B']
            except:
                answer1 = 0
            try:
                answer2 = pivot_table.loc['B is better than A', 'B is better than A']
            except:
                answer2 = 0
            try:
                both = pivot_table.loc['A and B are equally good', 'A and B are equally good']
            except:
                both = 0
            try:
                neither = pivot_table.loc['A and B are both unacceptable to present in front of a customer', 'A and B are both unacceptable to present in front of a customer']
            except:
                neither = 0
            ...
            if key == 'Download':
                if options == 'USER':
                    ...
                    rows = [
                        ...
                        'Q2. Does truthfulness evaluation apply to this answer? ',
                        'Q3. Which sections of the product page did you refer to as evidence for your evaluation? ',
                        'Q5. Is the answer free of any subjective statements? ', 
                        'Q6. Are the statements in the answer consistent with details in the product page? ',
                        'Q7. Is the answer consistent with the external sources that you found? ',
                        'Q8. Is the answer consistent with common sense?',
                        'Q9. Is the answer consistent with your own knowledge?_',
                        'Q10. Does the answer provide complete information based on the product page, evidence links, common knowledge, or personal knowledge?',
                        'Q11. Does the answer correctly convey the customer review sentiment?',
                        'Q12. Does the answer extract product attribute information from the product page accurately?', 
                        'Q13. Does the answer correctly attribute the source of the information? ',
                        'Q14. Is the answer free of hallucination?',
                        'Q15. Overall, is the answer truthful?',
                        'Q3. Which sections of the product page did you refer to as evidence for your evaluation?',
                        'Q5. Is the answer free of any subjective statements?',
                        'Q6. Are the statements in the answer consistent with details in the product page?',
                        'Q7. Is the answer consistent with the external sources that you found?', 
                        'Q8. Is the answer consistent with common sense?', 
                        'Q9. Is the answer consistent with your own knowledge?', 
                        'Q10. Does the answer provide complete information based on the product page, evidence links, common knowledge, or personal knowledge?',
                        'Q11. Does the answer correctly convey the customer review sentiment?',
                        'Q12. Does the answer extract product attribute information from the product page accurately?',
                        'Q13. Does the answer correctly attribute the source of the information?',
...
def userwisequalityreportDA1(userid):
    ...
    if (df_report['l1_prod__que12_ans1'].empty):
        the_audit_count = the_audit_count-1

    if (df_report['l1_prod__que13_ans1'].empty):
        the_audit_count = the_audit_count-1

    if (df_report['l1_prod__que14_ans1'].empty):
        the_audit_count = the_audit_count-1

    if (df_report['l1_prod__que15_ans1'].empty):
        the_audit_count = the_audit_count-1
    ...
    if (df_report['l1_prod__que12_ans2'].empty):
        the_audit_count = the_audit_count-1

    if (df_report['l1_prod__que13_ans2'].empty):
        the_audit_count = the_audit_count-1

    if (df_report['l1_prod__que14_ans2'].empty):
        the_audit_count = the_audit_count-1

    if (df_report['l1_prod__que15_ans2'].empty):
        the_audit_count = the_audit_count-1
    ...
    df_report['Q2. Does truthfulness evaluation apply to this answer? '] = (df_report['l1_prod__que2'] == df_report['l3_prod__que2'] )
    df_report['Q3. Which sections of the product page did you refer to as evidence for your evaluation? '] = (df_report['l1_prod__que3_ans1'] == df_report['l3_prod__que3_ans1'] )
    df_report['Q5. Is the answer free of any subjective statements? ',] = (df_report['l1_prod__que5_ans1'] == df_report['l3_prod__que5_ans1'] )
    df_report['Q6. Are the statements in the answer consistent with details in the product page? '] = (df_report['l1_prod__que6_ans1'] == df_report['l3_prod__que6_ans1'] )
    df_report['Q7. Is the answer consistent with the external sources that you found? '] = (df_report['l1_prod__que7_ans1'] == df_report['l3_prod__que7_ans1'] )
    df_report['Q8. Is the answer consistent with common sense?'] = (df_report['l1_prod__que8_ans1'] == df_report['l3_prod__que8_ans1'] )
    df_report['Q9. Is the answer consistent with your own knowledge?_'] = (df_report['l1_prod__que9_ans1'] == df_report['l3_prod__que9_ans1'] )
    df_report['Q10. Does the answer provide complete information based on the product page, evidence links, common knowledge, or personal knowledge?'] =  (df_report['l1_prod__que10_ans1'] == df_report['l3_prod__que10_ans1'] )
    df_report['Q11. Does the answer correctly convey the customer review sentiment?'] = (df_report['l1_prod__que11_ans1'] == df_report['l3_prod__que11_ans1'] )
    df_report['Q12. Does the answer extract product attribute information from the product page accurately?',] = (df_report['l1_prod__que12_ans1'] == df_report['l3_prod__que12_ans1'] )
    df_report['Q13. Does the answer correctly attribute the source of the information? '] = (df_report['l1_prod__que13_ans1'] == df_report['l3_prod__que13_ans1'] )
    df_report['Q14. Is the answer free of hallucination?'] = (df_report['l1_prod__que14_ans1'] == df_report['l3_prod__que14_ans1'] )
    df_report['Q15. Overall, is the answer truthful?'] = (df_report['l1_prod__que15_ans1'] == df_report['l3_prod__que15_ans1'] )
    df_report['Q3. Which sections of the product page did you refer to as evidence for your evaluation?'] = (df_report['l1_prod__que3_ans2'] == df_report['l3_prod__que3_ans2'] )
    df_report['Q5. Is the answer free of any subjective statements?'] = (df_report['l1_prod__que5_ans2'] == df_report['l3_prod__que5_ans2'] )
    df_report['Q6. Are the statements in the answer consistent with details in the product page?'] = (df_report['l1_prod__que6_ans2'] == df_report['l3_prod__que6_ans2'] )
    df_report['Q7. Is the answer consistent with the external sources that you found?',] = (df_report['l1_prod__que7_ans2'] == df_report['l3_prod__que7_ans2'] )
    df_report['Q8. Is the answer consistent with common sense?',] = (df_report['l1_prod__que8_ans2'] == df_report['l3_prod__que8_ans2'] )
    df_report['Q9. Is the answer consistent with your own knowledge?',] = (df_report['l1_prod__que9_ans2'] == df_report['l3_prod__que9_ans2'] )
    df_report['Q10. Does the answer provide complete information based on the product page, evidence links, common knowledge, or personal knowledge?'] = (df_report['l1_prod__que10_ans2'] == df_report['l3_prod__que10_ans2'] )
    df_report['Q11. Does the answer correctly convey the customer review sentiment?'] = (df_report['l1_prod__que11_ans2'] == df_report['l3_prod__que11_ans2'] )
    df_report['Q12. Does the answer extract product attribute information from the product page accurately?'] = (df_report['l1_prod__que12_ans2'] == df_report['l3_prod__que12_ans2'] )
    df_report['Q13. Does the answer correctly attribute the source of the information?'] = (df_report['l1_prod__que13_ans2'] == df_report['l3_prod__que13_ans2'] )
    df_report['Q14. Is the answer free of hallucination?'] = (df_report['l1_prod__que14_ans2'] == df_report['l3_prod__que14_ans2'] )
    df_report['Q15. Overall, is the answer truthful?'] = (df_report['l1_prod__que15_ans2'] == df_report['l3_prod__que15_ans2'] )
...
def userwisequalityreportDA2(userid):
    ...
    if (df_report['l2_prod__que12_ans1'].empty):
        the_audit_count = the_audit_count-1

    if (df_report['l2_prod__que13_ans1'].empty):
        the_audit_count = the_audit_count-1

    if (df_report['l2_prod__que14_ans1'].empty):
        the_audit_count = the_audit_count-1

    if (df_report['l2_prod__que15_ans1'].empty):
        the_audit_count = the_audit_count-1
    ...
    if (df_report['l2_prod__que12_ans2'].empty):
        the_audit_count = the_audit_count-1

    if (df_report['l2_prod__que13_ans2'].empty):
        the_audit_count = the_audit_count-1

    if (df_report['l2_prod__que14_ans2'].empty):
        the_audit_count = the_audit_count-1

    if (df_report['l2_prod__que15_ans2'].empty):
        the_audit_count = the_audit_count-1
    ...
    df_report['Q2. Does truthfulness evaluation apply to this answer? '] = (df_report['l2_prod__que2'] == df_report['l3_prod__que2'] )
    df_report['Q3. Which sections of the product page did you refer to as evidence for your evaluation? '] = (df_report['l2_prod__que3_ans1'] == df_report['l3_prod__que3_ans1'] )
    df_report['Q5. Is the answer free of any subjective statements? ',] = (df_report['l2_prod__que5_ans1'] == df_report['l3_prod__que5_ans1'] )
    df_report['Q6. Are the statements in the answer consistent with details in the product page? '] = (df_report['l2_prod__que6_ans1'] == df_report['l3_prod__que6_ans1'] )
    df_report['Q7. Is the answer consistent with the external sources that you found? '] = (df_report['l2_prod__que7_ans1'] == df_report['l3_prod__que7_ans1'] )
    df_report['Q8. Is the answer consistent with common sense?'] = (df_report['l2_prod__que8_ans1'] == df_report['l3_prod__que8_ans1'] )
    df_report['Q9. Is the answer consistent with your own knowledge?_'] = (df_report['l2_prod__que9_ans1'] == df_report['l3_prod__que9_ans1'] )
    df_report['Q10. Does the answer provide complete information based on the product page, evidence links, common knowledge, or personal knowledge?'] =  (df_report['l2_prod__que10_ans1'] == df_report['l3_prod__que10_ans1'] )
    df_report['Q11. Does the answer correctly convey the customer review sentiment?'] = (df_report['l2_prod__que11_ans1'] == df_report['l3_prod__que11_ans1'] )
    df_report['Q12. Does the answer extract product attribute information from the product page accurately?',] = (df_report['l2_prod__que12_ans1'] == df_report['l3_prod__que12_ans1'] )
    df_report['Q13. Does the answer correctly attribute the source of the information? '] = (df_report['l2_prod__que13_ans1'] == df_report['l3_prod__que13_ans1'] )
    df_report['Q14. Is the answer free of hallucination?'] = (df_report['l2_prod__que14_ans1'] == df_report['l3_prod__que14_ans1'] )
    df_report['Q15. Overall, is the answer truthful?'] = (df_report['l2_prod__que15_ans1'] == df_report['l3_prod__que15_ans1'] )
    df_report['Q3. Which sections of the product page did you refer to as evidence for your evaluation?'] = (df_report['l2_prod__que3_ans2'] == df_report['l3_prod__que3_ans2'] )
    df_report['Q5. Is the answer free of any subjective statements?'] = (df_report['l2_prod__que5_ans2'] == df_report['l3_prod__que5_ans2'] )
    df_report['Q6. Are the statements in the answer consistent with details in the product page?'] = (df_report['l2_prod__que6_ans2'] == df_report['l3_prod__que6_ans2'] )
    df_report['Q7. Is the answer consistent with the external sources that you found?',] = (df_report['l2_prod__que7_ans2'] == df_report['l3_prod__que7_ans2'] )
    df_report['Q8. Is the answer consistent with common sense?',] = (df_report['l2_prod__que8_ans2'] == df_report['l3_prod__que8_ans2'] )
    df_report['Q9. Is the answer consistent with your own knowledge?',] = (df_report['l2_prod__que9_ans2'] == df_report['l3_prod__que9_ans2'] )
    df_report['Q10. Does the answer provide complete information based on the product page, evidence links, common knowledge, or personal knowledge?'] = (df_report['l2_prod__que10_ans2'] == df_report['l3_prod__que10_ans2'] )
    df_report['Q11. Does the answer correctly convey the customer review sentiment?'] = (df_report['l2_prod__que11_ans2'] == df_report['l3_prod__que11_ans2'] )
    df_report['Q12. Does the answer extract product attribute information from the product page accurately?'] = (df_report['l2_prod__que12_ans2'] == df_report['l3_prod__que12_ans2'] )
    df_report['Q13. Does the answer correctly attribute the source of the information?'] = (df_report['l2_prod__que13_ans2'] == df_report['l3_prod__que13_ans2'] )
    df_report['Q14. Is the answer free of hallucination?'] = (df_report['l2_prod__que14_ans2'] == df_report['l3_prod__que14_ans2'] )
    df_report['Q15. Overall, is the answer truthful?'] = (df_report['l2_prod__que15_ans2'] == df_report['l3_prod__que15_ans2'] )
...
def iaa(request):
    batchname = basefile.objects.filter(Q(filename__isnull=False) & ~Q(
        filename='')).values('filename').distinct()
    ...
    if request.method == 'POST':
        try:
            ...
            columns_to_compare = [
                    ...
                    ('l1_prod__que12_ans1', 'l2_prod__que12_ans1','l3_prod__que12_ans1'),
                    ('l1_prod__que13_ans1', 'l2_prod__que13_ans1','l3_prod__que13_ans1'),
                    ('l1_prod__que14_ans1', 'l2_prod__que14_ans1','l3_prod__que14_ans1'),
                    ('l1_prod__que15_ans1', 'l2_prod__que15_ans1','l3_prod__que15_ans1'),
                    ...
                    ('l1_prod__que12_ans2', 'l2_prod__que12_ans2','l3_prod__que12_ans2'),
                    ('l1_prod__que13_ans2', 'l2_prod__que13_ans2','l3_prod__que13_ans2'),
                    ('l1_prod__que14_ans2', 'l2_prod__que14_ans2','l3_prod__que14_ans2'),
                    ('l1_prod__que15_ans2', 'l2_prod__que15_ans2','l3_prod__que15_ans2'),
                    ('l1_prod__annotation_comment','l2_prod__annotation_comment', 'l3_prod__annotation_comment')               
            ]
